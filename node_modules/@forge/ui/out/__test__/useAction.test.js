...
describe('useAction', () => {
    ...
    describe('invalid scenarios', () => {
        ...
        test('to throw an error if dispatch is called in an invalid location', async () => {
            ...
            return expect(renderEffect).rejects.toThrow('dispatch must be called inside of an event handler or within the function arguments of useAction, useState or useContentProperty');
        });
    });
});
